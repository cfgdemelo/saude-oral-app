...
public class Agendar extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_agendar);
        navigationView.setNavigationItemSelectedListener(this);
        View headerView = navigationView.getHeaderView(0);
        TextView textoNomeHeader = (TextView) headerView.findViewById(R.id.nameHeaderAgendar);
        TextView textoEmailHeader = (TextView) headerView.findViewById(R.id.emailHeaderAgendar);
        fab = (FloatingActionButton) findViewById(R.id.fab1);

        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Snackbar.make(v, "Não Disponível na versão Beta", Snackbar.LENGTH_LONG)
