...
public class Acompanhe extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acompanhe);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_acompanhe);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_acompanhe);
        navigationView.setNavigationItemSelectedListener(this);
        View headerView = navigationView.getHeaderView(0);
        TextView textoNomeHeader = (TextView) headerView.findViewById(R.id.nameHeaderAcompanhe);
        TextView textoEmailHeader = (TextView) headerView.findViewById(R.id.emailHeaderAcompanhe);
